...
//
//        goalRepository = new GoalRepository(db.goalDao());
//        reminderRepository = new ReminderRepository(db.reminderDao());
//        savedLocationRepository = new SavedLocationRepository(db.savedLocationDao());
//        tripRepository = new TripRepository(db.tripDao());
//    }
//
//    @After
//    public void closeDb() {
...
//
//    @Test
//    public void testLoadGoals() throws InterruptedException {
//        Goal goal1 = new Goal(Goal.METRIC_KILOMETERS,2,Goal.TIMEFRAME_WEEK,0.0,10.0,new Date());
//        Goal goal2 = new Goal(Goal.METRIC_STEPS,2,Goal.TIMEFRAME_DAY,3.0,15.0,new Date());
//        goalRepository.addNewGoal(goal1,null); // This is now asynchronous
//        goalRepository.addNewGoal(goal2,null); // This is now asynchronous
//
//        // Use LiveDataTestUtil to wait for LiveData to complete
//        List<Goal> goals = LiveDataTestUtil.getValue(goalRepository.loadGoals());
//
...
//    // Reminders
//    @Test
//    public void testLoadRemindersForLocation() throws InterruptedException {
//        // Insert some test data
//        long locationId = 1;
//        Reminder reminder1 = new Reminder(locationId, "Reminder1");
//        Reminder reminder2 = new Reminder(locationId, "Reminder2");
//        reminderRepository.addNewReminder(reminder1);
//        reminderRepository.addNewReminder(reminder2);
//
//        // Load reminders for a location
//        List<Reminder> reminders = LiveDataTestUtil.getValue(reminderRepository.loadRemindersForLocation(locationId));
//
